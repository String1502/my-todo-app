...
import { NewTaskModalProps, defaultTask } from "./NewTaskModal";

export const NewTaskModal: React.FC<NewTaskModalProps> = ({ handleClose }) => {
  ...
  useEffect(() => {
    ...
    const getData = async () => {
      ...
      const themesSnapshot = getDocs(collection(db, themesPath).withConverter(themeConverter));
    };
